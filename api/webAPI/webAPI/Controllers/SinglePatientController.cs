...
{
    public class SinglePatientController : ApiController
    {

        public HttpResponseMessage Get() {
            string query = @"
                select TOP 1 id, name, surname, genre, bornDate, SSNumber, bloodType, adress, postalCode, phoneNumber
                from dbo.pacientes ORDER BY NEWID()
            ";
